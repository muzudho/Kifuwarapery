...
// MoveType の全ての指し手を生成
//FIXME: MoveStack* generateMoves_mt(MoveType MT, MoveStack* moveStackList, const Position& pos);

//FIXME: MoveStack* generateMoves_mt(MoveType MT, MoveStack* moveStackList, const Position& pos, const Square to);
...
public:
	...
	explicit MoveList(const Position& pos) :
		m_curr_(m_moveStackList_), m_last_(MoveGenerator200::GenerateMoves_mt3(MT, m_moveStackList_, pos))
	{
	}
