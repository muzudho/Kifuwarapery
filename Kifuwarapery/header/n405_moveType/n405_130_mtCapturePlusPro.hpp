...
public:
	...
	MoveStack* GenerateMoves1(
		...
		const Bitboard targetPawn = mtEvent.m_pos.GetBbOf(mtEvent.m_oppositeColor) | (mtEvent.m_pos.GetOccupiedBB().NotThisAnd(mtEvent.m_tRank789BB));
